...
public class search_connection_service {
    ...
    class RequestTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... uri) {
            ...
            try {
                ...
                String url = "https://api.mongolab.com/api/1/databases/rookart/collections/applied?apiKey=MYcIcd_YznZ7rTPOUHzbL-UqfjJq7eR8";
