...
public class job_post_service extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_job_post_service);
        ...
        final EditText mobile = (EditText) findViewById(R.id.post_editText8);
        final EditText mail = (EditText) findViewById(R.id.post_textemail);
        ...
        map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in=new Intent(getApplicationContext(),MAPS_service.class);
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    post_connection_service con= new post_connection_service();
                    if(!map.isChecked())
                    {
                    ...
                    con.push(user,title.getText().toString(),description.getText().toString(),longitude,latitude,mobile.getText().toString(),mail.getText().toString(),price.getText().toString());
                } catch (IOException e) {
                    Toast.makeText(getApplicationContext(),"error",Toast.LENGTH_SHORT);
                    e.printStackTrace();
                }
                Toast.makeText(getApplicationContext(),"service posted",Toast.LENGTH_SHORT).show();
            }
        });
